...
def run_mp(input_stream1, input_stream2, P0, P1):
    ...
    while True:
        ...
        if k & 0xFF == 32: # Press space (space = 32) and get calibration point; this will be written in points of interest.dat
          pointsOfInterest.append(frame_p3ds)
          #Get origin (0,0), y (0;1),x (1;0),z (height)
...
if __name__ == '__main__':
    ...
    kpts_cam0, kpts_cam1, kpts_3d, pointOfInterest = run_mp(input_stream1, input_stream2, P0, P1)

    #this will create keypoints file in current working folder
    write_keypoints_to_disk('kpts_cam0.dat', kpts_cam0)
    write_keypoints_to_disk('kpts_cam1.dat', kpts_cam1)
    write_keypoints_to_disk('kpts_3d.dat', kpts_3d)
    write_keypoints_to_disk('pointsOfInterest.dat', pointOfInterest)
