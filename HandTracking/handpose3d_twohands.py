...
def run_mp(input_stream1, input_stream2, P0, P1):
    ...
    while True:
        ...
        frame_p3ds = np.array(frame_kpts_rotated).reshape((len(frame_kpts_rotated), 3))
        #can also be reshape(21, 6) instead of (42,3)
        ...
        message = " "
        # for i in range(0, 21):
        for i in range(0, len(frame_kpts_rotated)):
            # if i%5 == 0:
