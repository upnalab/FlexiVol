namespace OpenCvSharp.Demo
{
	...
	public class CreateTexture2D : MonoBehaviour
	{
		...
		private Color32[] pixelsR, pixelsG, pixelsB;
	    ...
	    void Update()
	    {
	        ...
	        // var mip1Data = myTexture.GetPixelData<Color32>(1);
        	...
        	for(int j = 0; j < 8; j++)
        	{
        		for(int i = 0; i < pixelsTexture.Length; i++)
	        	{
	        		...
	        		pixelsR[i] = new Color32((byte)(Mathf.Floor(pixelsTexture[i].r/Mathf.Pow(2,(j+1))) % 2), 0, 0, 1);
