...
namespace Voxon
{
    public class ParticleViewBillBoard : ParticleView
    {
        ...
        public ParticleViewBillBoard(ParticleModel particle, bool useWorldSpace = false, int reduceColorDensity = 1, float sizeMultiplier = 1, float zOffset = 0, GameObject parent = null) : base(particle, parent) 
        {
